classdef YWaveAnalyzerAppv3 < matlab.apps.AppBase
    ...
    methods (Access = private)
        ...
        function ExportToExcelButtonPushed(app, event)
            ...
            try
                ...
                summaryHeaders = {'Folder', 'Total Events', 'Mean Amplitude (pA)', 'Frequency (Hz)', 'Time (min)'};
    ...
    methods (Access = private)
        ...
        function createComponents(app)
            ...
            app.MaxAmpLabel.Position = [10 45 50 22];

            % Create MaxAmpField
            app.MaxAmpField = uieditfield(app.FilterPanel, 'numeric');
            app.MaxAmpField.Position = [65 45 135 22];
            app.MaxAmpField.Value = 10000;
            ...
            app.AnalyzedWavesListBox.Position = [10 10 190 60];
            app.AnalyzedWavesListBox.FontSize = 9;

            % Create CreateAverageCDFButton
            app.CreateAverageCDFButton = uibutton(app.LeftPanel, 'push');
            app.CreateAverageCDFButton.ButtonPushedFcn = createCallbackFcn(app, @CreateAverageCDFButtonPushed, true);
            app.CreateAverageCDFButton.Position = [75 231 95 25];
            app.CreateAverageCDFButton.Text = 'Create Avg';
            app.CreateAverageCDFButton.Enable = 'off';
            app.CreateAverageCDFButton.FontSize = 11;

            % Create ClearAveragesButton
            app.ClearAveragesButton = uibutton(app.LeftPanel, 'push');
            app.ClearAveragesButton.ButtonPushedFcn = createCallbackFcn(app, @ClearAveragesButtonPushed, true);
            app.ClearAveragesButton.Position = [175 231 90 25];
            app.ClearAveragesButton.Text = 'Clear';
            app.ClearAveragesButton.Enable = 'off';
            app.ClearAveragesButton.FontSize = 11;

            % Create FilterStatusLabel
            app.FilterStatusLabel = uilabel(app.LeftPanel);
            app.FilterStatusLabel.Position = [10 220 430 22];
            app.FilterStatusLabel.Text = 'No filters applied';
            ...
            app.ExportToExcelButton.Position = [10 185 430 30];
            ...
            app.SummaryTable.ColumnName = {'Folder'; 'Total Events'; 'Mean Amp (pA)'; 'Freq (Hz)'; 'Time (min)'};
            app.SummaryTable.RowName = {};
            app.SummaryTable.Position = [10 10 430 165];
            app.SummaryTable.ColumnWidth = {55, 80, 85, 60, 70};
    ...
    methods (Access = public)
        ...
        % Construct app
        function app = YWaveAnalyzerAppv3
